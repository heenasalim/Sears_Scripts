...
#<>                                   HEADER                                <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_smith__idrp_obu_default_fulfillment_sears_daily_format.pig
...
--load existing data
existing_data = 
    LOAD '$SMITH__IDRP_OBU_DEFAULT_FULFILLMENT_SEARS_DAILY_INCOMING_LOCATION' 
    USING PigStorage('$FIELD_DELIMITER_CONTROL_A')
    AS ( $SMITH__IDRP_OBU_DEFAULT_FULFILLMENT_SEARS_DAILY_INCOMING_SCHEMA );
...
formatted_data = 
    ...
    GENERATE 
        ...
        TRIM_STRING(sears_division_nbr),
        TRIM_STRING(sears_item_nbr),
        TRIM_STRING(sears_sku_nbr),
        TRIM_STRING(upc_nbr),
...
INTO '$SMITH__IDRP_OBU_DEFAULT_FULFILLMENT_SEARS_DAILY_LOCATION' 
USING PigStorage('$FIELD_DELIMITER_CONTROL_A');
