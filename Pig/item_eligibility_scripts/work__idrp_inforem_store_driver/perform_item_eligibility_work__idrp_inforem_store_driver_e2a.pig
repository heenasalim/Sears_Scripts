...
--load ebcidic data
ebcidic_data = LOAD '$WORK__IDRP_INFOREM_STORE_DRIVER_INCOMING_LOCATION' 
           USING com.sears.hadoop.pig.piggybank.storage.ebcidic.EBCIDICStorage('$WORK__IDRP_INFOREM_STORE_DRIVER_COPYBOOK_INCOMING_LOCATION');

--convert ebcidic data and store
STORE ebcidic_data 
INTO '$WORK__IDRP_INFOREM_STORE_DRIVER_CONVERTED_WORK_LOCATION' 
USING com.sears.hadoop.pig.piggybank.storage.ebcidic.text.TextStorage('$WORK__IDRP_INFOREM_STORE_DRIVER_COPYBOOK_INCOMING_LOCATION','$FIELD_DELIMITER_CONTROL_A');
