...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         PerformAggHistTransformationPart3bsh
...
script_name=PerformAggHistTransformationPart3c
...
fn_delete_hadoop_directory_if_it_already_exist $union_sec8_p12a

#execute the pig script

fn_execute_pig \
-m ${pig_params_file} \
-m ${PIG_SCHEMAS_DIR}/agghist/PerformAggHistTransformationPart3c.schema \
${pig_script_file}
