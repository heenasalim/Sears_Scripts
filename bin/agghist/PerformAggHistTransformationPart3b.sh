...
script_name=PerformAggHistTransformationPart3b
...
fn_delete_hadoop_directory_if_it_already_exist $union_sec5_p13a
...
fn_execute_pig \
-m ${pig_params_file} \
-m ${PIG_SCHEMAS_DIR}/agghist/PerformAggHistTransformationPart3b.schema \
