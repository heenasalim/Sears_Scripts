...
# SCRIPT NAME:         perform_online_fulfillment_initialization_smith__idrp_online_billable_weight_1.sh
...
script_name=perform_online_fulfillment_initialization_smith__idrp_online_billable_weight_1
...
fn_execute_pig -m ${pig_params_file} -m $PIG_SCHEMAS_DIR/smith__idrp_obu_billable_weight_daily.schema -m $PIG_SCHEMAS_DIR/work__idrp_item_hierarchy_combined_all_current.schema ${pig_script_file}
