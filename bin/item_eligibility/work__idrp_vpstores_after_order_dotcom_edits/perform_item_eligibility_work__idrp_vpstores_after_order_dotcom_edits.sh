...
# SCRIPT NAME:         perform_item_eligibility_work__idrp_vpstores_after_order_dotcom_edits.sh
# AUTHOR NAME:         Onkar Malewadikar
# CREATION DATE:       Thu Apr 24 03:32:11 EDT 2014
...
module_relative_path=item_eligibility/work__idrp_vpstores_after_order_dotcom_edits

#this is the name of the script without extension
script_name=perform_item_eligibility_work__idrp_vpstores_after_order_dotcom_edits
...
. ${pig_params_file}
. ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_vpstores_after_order_dotcom_edits.schema
###############################################################################
#<>                                  BODY                                   <>#
###############################################################################

fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_VPSTORES_AFTER_ORDER_DOTCOM_EDITS_LOCATION
#execute the pig script
fn_execute_pig -m ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_vpstores_after_order_dotcom_edits.schema -m ${PIG_SCHEMAS_DIR}/gold__geographic_location_master.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_post_drop_ship_proc.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_eligible_loc.schema -m ${pig_params_file} ${pig_script_file}
