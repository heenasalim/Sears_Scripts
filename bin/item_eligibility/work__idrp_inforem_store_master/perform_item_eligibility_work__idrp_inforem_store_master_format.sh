...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_work__idrp_inforem_store_master_format.sh
...
script_name=perform_item_eligibility_work__idrp_inforem_store_master_format
...
work_formatted_dir=${WORK__IDRP_INFOREM_STORE_MASTER_FORMATTED_WORK_LOCATION}
