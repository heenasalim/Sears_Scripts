...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_smith__idrp_obu_default_fulfillment_kmart_daily_format.sh
...
module_relative_path=item_eligibility/smith__idrp_obu_default_fulfillment_kmart_daily

#this is the name of the script without extension
script_name=perform_item_eligibility_smith__idrp_obu_default_fulfillment_kmart_daily_format

#pig schema file
pig_schema_file=${PIG_SCHEMAS_DIR}/smith__idrp_obu_default_fulfillment_kmart_daily.schema
...
fn_delete_hadoop_directory_if_it_already_exist $SMITH__IDRP_OBU_DEFAULT_FULFILLMENT_KMART_DAILY_INCOMING_LOCATION

#copy raw data from linux directory to hdfs
fn_parallel_copy_files_from_linux_to_hadoop $SMITH__IDRP_OBU_DEFAULT_FULFILLMENT_KMART_DAILY_STAGING_LOCATION $SMITH__IDRP_OBU_DEFAULT_FULFILLMENT_KMART_DAILY_INCOMING_LOCATION

#remove target directory if it already exists
fn_delete_hadoop_directory_if_it_already_exist $SMITH__IDRP_OBU_DEFAULT_FULFILLMENT_KMART_DAILY_LOCATION
