...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_work__idrp_item_rpt_grp_format.sh
...
script_name=perform_item_eligibility_work__idrp_item_rpt_grp_format
...
work_dir=${WORK__IDRP_ITEM_RPT_GRP_WORK_LOCATION}

#smith location
output_dir=${WORK__IDRP_ITEM_RPT_GRP_LOCATION}
###############################################################################
#<>                                  BODY                                   <>#
###############################################################################
