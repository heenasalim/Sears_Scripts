...
# SCRIPT NAME:         perform_online_fulfillment_initialization_smith__idrp_online_drop_ship_items.sh
...
module_relative_path=item_eligibility/smith__idrp_online_drop_ship_items

#this is the name of the script without extension
script_name=perform_online_fulfillment_initialization_smith__idrp_online_drop_ship_items
...
#<>                                  BODY                                   <>#
###############################################################################
. $PIG_SCHEMAS_DIR/smith__idrp_online_drop_ship_items.schema

fn_delete_hadoop_directory_if_it_already_exist $SMITH__IDRP_ONLINE_DROP_SHIP_ITEMS_LOCATION

execute the pig script
fn_execute_pig -m ${pig_params_file} -m $PIG_SCHEMAS_DIR/smith__item_combined_hierarchy_current.schema -m $PIG_SCHEMAS_DIR/gold__item_vendor_package_current.schema -m $PIG_SCHEMAS_DIR/smith__idrp_online_drop_ship_items.schema  ${pig_script_file}
