...
# SCRIPT NAME:         perform_item_eligibility_smith__idrp_eligible_item_location_current.sh
...
fn_delete_hadoop_directory_if_it_already_exist $SMITH__IDRP_ELIGIBLE_ITEM_LOCATION_CURRENT_LOCATION

#execute the pig script
fn_execute_pig -m ${PIG_PARAMS_FILE} -m ${PIG_SCHEMAS_DIR}/smith__idrp_eligible_item_location_current.schema ${PIG_SCRIPT_FILE}
