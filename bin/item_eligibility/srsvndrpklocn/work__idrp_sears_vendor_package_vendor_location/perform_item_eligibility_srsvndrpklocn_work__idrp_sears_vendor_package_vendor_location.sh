...
# SCRIPT NAME:         perform_item_eligibility_srsvndrpklocn_work__idrp_sears_vendor_package_vendor_location.sh
...
#	04/05/2020  Rajani Galpalli   IPS-4912: Added empty file check for few Hadoop files
#
#
###############################################################################
#<<                               INITIALIZE                                >>#
...
module_relative_path=item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_vendor_location

#this is the name of the script without extension
script_name=perform_item_eligibility_srsvndrpklocn_work__idrp_sears_vendor_package_vendor_location
...
fn_non_zero_file_check $module_relative_path "$WORK__IDRP_SEARS_VENDOR_PACKAGE_LOCATION_LOCATION $WORK__IDRP_SEARS_VENDOR_PACKAGE_EXPLODING_ASSORTMENT_LOCATION_LOCATION" $CURRENT_DATE
...
# fn_non_zero_file_check $module_relative_path "$WORK__IDRP_SEARS_VENDOR_PACKAGE_LOCATION_LOCATION $WORK__IDRP_SEARS_VENDOR_PACKAGE_EXPLODING_ASSORTMENT_LOCATION_LOCATION $SMITH__IDRP_KSN_ATTRIBUTE_CURRENT_LOCATION $SMITH__IDRP_ELIGIBLE_LOC_LOCATION $SMITH__IDRP_VEND_PACK_COMBINED_LOCATION $SMITH__IDRP_VEND_PACK_DC_COMBINED_LOCATION" $CURRENT_DATE

. ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_vendor_location.schema

fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_SEARS_VENDOR_PACKAGE_VENDOR_LOCATION_LOCATION

#execute the pig script
fn_execute_pig -m ${pig_params_file} -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_location.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_exploding_assortment_location.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_ksn_attribute_current.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_eligible_loc.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_dc_combined.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_vendor_location.schema ${pig_script_file}
