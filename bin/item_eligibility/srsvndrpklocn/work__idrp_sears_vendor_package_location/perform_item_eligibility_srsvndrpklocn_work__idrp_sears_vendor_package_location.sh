...
# SCRIPT NAME:         perform_item_eligibility_srsvndrpklocn_work__idrp_sears_vendor_package_location.sh
...
module_relative_path=item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_location

#this is the name of the script without extension
script_name=perform_item_eligibility_srsvndrpklocn_work__idrp_sears_vendor_package_location
...
fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_SEARS_VENDOR_PACKAGE_LOCATION_LOCATION

#execute the pig script
fn_execute_pig -m ${pig_params_file} -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sourced_sears_location.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_dc_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_shc_item_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_eligible_loc.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_ksn_attribute_current.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_location.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_scan_based_trading_sears_location_current.schema ${pig_script_file}
