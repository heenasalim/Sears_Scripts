...
# SCRIPT NAME:         perform_item_eligibility_srsvndrpklocn_work__idrp_sears_vendor_package_exploding_assortment_location.sh
...
module_relative_path=item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_exploding_assortment_location

#this is the name of the script without extension
script_name=perform_item_eligibility_srsvndrpklocn_work__idrp_sears_vendor_package_exploding_assortment_location
...
. ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_dc_combined.schema 
. ${PIG_SCHEMAS_DIR}/smith__idrp_shc_item_combined.schema 
. ${PIG_SCHEMAS_DIR}/smith__idrp_core_ima_assortments_prepacks_exploding_assortment_current.schema 
. ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_exploding_assortment_location.schema 
 
fn_non_zero_file_check $module_relative_path "$WORK__IDRP_SEARS_VENDOR_PACKAGE_LOCATION_LOCATION $WORK__IDRP_SEARS_LOCATION_XREF_LOCATION $WORK__IDRP_DUMMY_VEND_WHSE_REF_LOCATION $WORK__IDRP_SEARS_LOCATION_XREF_LOCATION $SMITH__IDRP_KSN_ATTRIBUTE_CURRENT_LOCATION $SMITH__IDRP_ELIGIBLE_LOC_LOCATION $SMITH__IDRP_VEND_PACK_COMBINED_LOCATION $SMITH__IDRP_VEND_PACK_DC_COMBINED_LOCATION $SMITH__IDRP_SHC_ITEM_COMBINED_LOCATION $SMITH__IDRP_CORE_IMA_ASSORTMENTS_PREPACKS_EXPLODING_ASSORTMENT_CURRENT_LOCATION" $CURRENT_DATE

. ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_exploding_assortment_location.schema

fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_SEARS_VENDOR_PACKAGE_EXPLODING_ASSORTMENT_LOCATION_LOCATION

#execute the pig script
fn_execute_pig -m ${pig_params_file} -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_location.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_dummy_vend_whse_ref.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_location_xref.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_ksn_attribute_current.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_eligible_loc.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_dc_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_shc_item_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_core_ima_assortments_prepacks_exploding_assortment_current.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_vendor_package_exploding_assortment_location.schema ${pig_script_file}
