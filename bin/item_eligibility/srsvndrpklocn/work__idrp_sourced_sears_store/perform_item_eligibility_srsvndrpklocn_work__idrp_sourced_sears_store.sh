...
# SCRIPT NAME:         perform_item_eligibility_srsvndrpklocn_work__idrp_sourced_sears_store.sh
...
module_relative_path=item_eligibility/srsvndrpklocn/work__idrp_sourced_sears_store

#this is the name of the script without extension
script_name=perform_item_eligibility_srsvndrpklocn_work__idrp_sourced_sears_store
...
fn_non_zero_file_check $module_relative_path "$WORK__IDRP_CANDIDATE_SEARS_STORE_LOCATION $WORK__RRC_MINIMUM_VENDOR_LOCATION $WORK__DDC_MINIMUM_VENDOR_LOCATION $WORK__IMPORT_MINIMUM_VENDOR_LOCATION $SMITH__IDRP_I2K_SEARS_REBUY_VENDOR_PACKAGE_CURRENT_LOCATION $WORK__IDRP_SEARS_LOCATION_XREF_LOCATION" $CURRENT_DATE


. ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sourced_sears_store.schema

#delete the output HDFS directory
fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_SOURCED_SEARS_STORE_LOCATION


#execute the pig script
fn_execute_pig -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_candidate_sears_store.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sears_location_xref.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_i2k_sears_rebuy_vendor_package_current.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__dd_import_minimum_vendor.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_sourced_sears_store.schema ${pig_script_file}
