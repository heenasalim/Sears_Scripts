...
# SCRIPT NAME:         perform_item_eligibility_srsvndrpklocn_work__dd_import_minimum_vendor.sh
...
module_relative_path=item_eligibility/srsvndrpklocn/work__dd_import_minimum_vendor

#this is the name of the script without extension
script_name=perform_item_eligibility_srsvndrpklocn_work__dd_import_minimum_vendor
...
fn_non_zero_file_check $module_relative_path  "$WORK__IDRP_CANDIDATE_SEARS_WAREHOUSE_LOCATION $WORK__IDRP_CANDIDATE_SEARS_STORE_LOCATION" $CURRENT_DATE


. ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__dd_import_minimum_vendor.schema

#delete the output HDFS directory
fn_delete_hadoop_directory_if_it_already_exist $WORK__DD_IMPORT_MINIMUM_VENDOR_LOCATION

fn_delete_hadoop_directory_if_it_already_exist $WORK__RRC_MINIMUM_VENDOR_LOCATION

fn_delete_hadoop_directory_if_it_already_exist $WORK__DDC_MINIMUM_VENDOR_LOCATION
	
fn_delete_hadoop_directory_if_it_already_exist $WORK__IMPORT_MINIMUM_VENDOR_LOCATION


#execute the pig script
fn_execute_pig -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_candidate_sears_warehouse.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__dd_import_minimum_vendor.schema  -m ${PIG_SCHEMAS_DIR}/item_eligibility/srsvndrpklocn/work__idrp_candidate_sears_store.schema ${pig_script_file}
