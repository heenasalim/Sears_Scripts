...
# SCRIPT NAME:         perform_item_eligibility_smith__idrp_time_phased_status_current.sh
...
fn_delete_hadoop_directory_if_it_already_exist $SMITH__IDRP_TIME_PHASED_STATUS_CURRENT_LOCATION

#execute the pig script
fn_execute_pig -m ${PIG_PARAMS_FILE} -m ${PIG_SCHEMAS_DIR}/smith__idrp_time_phased_status_current.schema ${PIG_SCRIPT_FILE}
