...
# SCRIPT NAME:         perform_online_fulfillment_initialization_smith__idrp_online_fulfillment_2.sh
...
script_name=perform_online_fulfillment_initialization_smith__idrp_online_fulfillment_2
...
#<>                                  BODY                                   <>#
###############################################################################
. $PIG_SCHEMAS_DIR/smith__idrp_online_fulfillment.schema
...
fn_execute_pig -m ${pig_params_file} -m $PIG_SCHEMAS_DIR/smith__idrp_online_fulfillment.schema -m $PIG_SCHEMAS_DIR/smith__idrp_eligible_item_current.schema ${pig_script_file}


. $PIG_SCHEMAS_DIR/smith__idrp_online_fulfillment.schema

fn_delete_hadoop_directory_if_it_already_exist $SMITH__IDRP_ONLINE_FULFILLMENT_LOCATION

fn_move_hadoop_directory_if_target_location_does_not_exists $WORK_LOCATION $SMITH__IDRP_ONLINE_FULFILLMENT_LOCATION
