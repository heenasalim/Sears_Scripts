...
# SCRIPT NAME:         perform_item_eligibility_work__idrp_kmart_vendor_package_location_combined.sh
...
module_relative_path=item_eligibility/kmtvndrpklocn/work__idrp_kmart_vendor_package_location_combined

#this is the name of the script without extension
script_name=perform_item_eligibility_work__idrp_kmart_vendor_package_location_combined
...
. ${PIG_SCHEMAS_DIR}/item_eligibility/kmtvndrpklocn/work__idrp_kmart_vendor_package_location_combined.schema

fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_KMART_VENDOR_PACKAGE_LOCATION_COMBINED_LOCATION
fn_delete_hadoop_directory_if_it_already_exist $NETAPP_VEND_PACK_LOC_LOCATION

#execute the pig script
fn_execute_pig -m ${pig_params_file} -m ${PIG_SCHEMAS_DIR}/item_eligibility/kmtvndrpklocn/work__idrp_kmart_vendor_package_location_store_level.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/kmtvndrpklocn/work__idrp_kmart_vendor_package_location_warehouse_level.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/kmtvndrpklocn/work__idrp_kmart_vendor_package_location_vendor_level.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/kmtvndrpklocn/work__idrp_kmart_vendor_package_location_combined.schema ${pig_script_file}
