...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_work__idrp_inforem_dc_inbound_vend_pack_e2a.sh
...
script_name=perform_item_eligibility_work__idrp_inforem_dc_inbound_vend_pack_e2a
...
staging_dir=${WORK__IDRP_INFOREM_DC_INBOUND_VEND_PACK_STAGING_LOCATION}

#hdfs directory where the raw data will be stored
incoming_dir=${WORK__IDRP_INFOREM_DC_INBOUND_VEND_PACK_INCOMING_LOCATION}

#directory where the formatted data will be stored
work_converted_dir=${WORK__IDRP_INFOREM_DC_INBOUND_VEND_PACK_CONVERTED_WORK_LOCATION}
...
fn_copy_from_local_dir_to_hadoop_dir "${staging_dir}" "${incoming_dir}"
