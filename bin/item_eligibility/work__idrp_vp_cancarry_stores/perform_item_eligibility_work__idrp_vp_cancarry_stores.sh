...
# SCRIPT NAME:         perform_item_eligibility_work__idrp_vp_cancarry_stores.sh
...
module_relative_path=item_eligibility/work__idrp_vp_cancarry_stores

#this is the name of the script without extension
script_name=perform_item_eligibility_work__idrp_vp_cancarry_stores
...
. ${pig_params_file}
. ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_vp_cancarry_stores.schema
###############################################################################
#<>                                  BODY                                   <>#
###############################################################################

fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_VP_EXAS_DOTCOM_CANCARRY_STORES_LOCATION

#execute the pig script
fn_execute_pig -m ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_vp_cancarry_stores.schema -m ${PIG_SCHEMAS_DIR}/gold__geographic_model_store.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_space_planning_authorized_vendor_package_stores_current.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_items_vend_packs_can_carry.schema -m ${pig_params_file} ${pig_script_file}
