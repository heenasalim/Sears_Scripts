...
# SCRIPT NAME:         perform_item_eligibility_work__idrp_items_vend_packs_can_carry.sh
...
module_relative_path=item_eligibility/work__idrp_items_vend_packs_can_carry

#this is the name of the script without extension
script_name=perform_item_eligibility_work__idrp_items_vend_packs_can_carry
...
. ${pig_params_file}
. ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_items_vend_packs_catg_rvw.schema
. ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_items_vend_packs_can_carry.schema

###############################################################################
#<>                                  BODY                                   <>#
###############################################################################

fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_ITEMS_VEND_PACKS_CAN_CARRY_LOCATION
fn_delete_hadoop_directory_if_it_already_exist $WORK__IDRP_ITEMS_VEND_PACKS_CATG_RVW_LOCATION

#execute the pig script
fn_execute_pig -m ${pig_params_file} -m ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_items_vend_packs_can_carry.schema -m ${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_items_vend_packs_catg_rvw.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_shc_item_combined.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_item_eligibility_batchdate.schema -m ${PIG_SCHEMAS_DIR}/smith__idrp_vend_pack_combined.schema ${pig_script_file}
