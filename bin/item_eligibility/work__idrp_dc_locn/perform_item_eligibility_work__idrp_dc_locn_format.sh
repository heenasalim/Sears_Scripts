...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_work__idrp_dc_locn_format.sh
...
script_name=perform_item_eligibility_work__idrp_dc_locn_format
...
work_dir=${WORK__IDRP_DC_LOCN_WORK_LOCATION}

#smith location
output_dir=${WORK__IDRP_DC_LOCN_LOCATION}
###############################################################################
#<>                                  BODY                                   <>#
###############################################################################
