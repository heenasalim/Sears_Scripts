...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_work__idrp_inforem_store_driver_format.sh
# AUTHOR NAME:         Abhijeet Shingate
# CREATION DATE:       Mon Oct 14 05:09:40 EDT 2013
...
module_relative_path=item_eligibility/work__idrp_inforem_store_driver

#this is the name of the script without extension
script_name=perform_item_eligibility_work__idrp_inforem_store_driver_format

#pig params file
pig_schema_file=${PIG_SCHEMAS_DIR}/item_eligibility/work__idrp_inforem_store_driver.schema

#pig params file
pig_params_file=${PIG_PARAMS_DIR}/${module_relative_path}/perform_item_eligibility_work__idrp_inforem_store_driver.param
...
work_formatted_dir=${WORK__IDRP_INFOREM_STORE_DRIVER_FORMATTED_WORK_LOCATION}

#smith location
smith_dir=${WORK__IDRP_INFOREM_STORE_DRIVER_LOCATION}
###############################################################################
#<>                                  BODY                                   <>#
###############################################################################
