...
#<>                                HEADER                                   <>#
###############################################################################
# SCRIPT NAME:         perform_item_eligibility_work__idrp_inforem_store_driver_e2a.sh
...
script_name=perform_item_eligibility_work__idrp_inforem_store_driver_e2a
...
staging_dir=${WORK__IDRP_INFOREM_STORE_DRIVER_STAGING_LOCATION}

#hdfs directory where the raw data will be stored
incoming_dir=${WORK__IDRP_INFOREM_STORE_DRIVER_INCOMING_LOCATION}

#directory where the formatted data will be stored
work_converted_dir=${WORK__IDRP_INFOREM_STORE_DRIVER_CONVERTED_WORK_LOCATION}
