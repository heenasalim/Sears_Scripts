...
JOB_NAME=INFOREM_STORE_DRIVER_EBCIDIC_CONVERSION

linux_staging_path=/staging/hdidrp/mainframe/kmart/inforem/store_driver
hdfs_incoming_path=/incoming/idrp/mainframe/data/kmart/inforem/store_driver
hdfs_copybook_dir=/incoming/idrp/mainframe/copybook/kmart
linux_copybook_dir=/appl/hdidrp/mainframe/copybook
copybook_name=INFOREM-STORE-DRIVER.cpbk
...
pig -logfile /logs/hdidrp/pig -param_file /appl/hdidrp/pig/params/item_eligibility/data/ebcidic_INFOREM_STORE_DRIVER.properties /appl/hdidrp/pig/scripts/item_eligibility/data_sourcing/ebsidic_2_ascii.pig
