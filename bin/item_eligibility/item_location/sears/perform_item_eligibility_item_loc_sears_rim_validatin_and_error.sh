##############################################################################################################################
#
#       Script Name   : perform_item_eligibility_item_loc_sears_rim_validation.sh
#
#       Description   : This is a wrapper script for invoking all hadoop jobs for item_eligibility_sears_rim validation
#
#       Author        : Mudit Mangal
...
# Validation and Audit of RIM DATA

pig -p batch_id=$1 -logfile $HDIDRP_LOG_FILE_DIR/pig -p WORK_DIR=$WORK_DIR -p SMITH_DIR=$SMITH_DIR -p GOLD_DIR=$GOLD_DIR -param_file $PIG_PARAM_PATH/item_eligibility_item_loc_sears_rim_validation.param $PIG_SCRIPT_PATH/../../../shared/generic_validation_audit.pig
