##############################################################################################################################
#
#       Script Name   : perform_item_eligibility_item_loc_sears_rim_join.sh
#
#       Description   : This is a wrapper script for invoking all hadoop jobs for item_eligibility_sears_rim join
#
#       Author        : Mudit Mangal
...
hadoop fs -test -e /work/idrp/item_eligibility/item_loc/sears/dummy_vend/*
result=$?

if [[ $result != 0 ]]; then
hadoop fs -copyFromLocal /appl/hdidrp/pig/scripts/item_eligibility/item_loc/sears/dummy_vend_whse_ref /work/idrp/item_eligibility/item_loc/sears/dummy_vend/*
fi
