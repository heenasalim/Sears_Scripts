##############################################################################################################################
#
#       Script Name   : perform_item_eligibility_item_loc_sears_srim_validation.sh
#
#       Description   : This is a wrapper script for invoking all hadoop jobs for item_eligibility_sears_srim validation
#
#       Author        : Mudit Mangal
...
# Validation and Audit of SRIM DATA

pig -p batch_id=$1 -p WORK_DIR=$WORK_DIR -logfile $HDIDRP_LOG_FILE_DIR/pig -p SMITH_DIR=$SMITH_DIR -p GOLD_DIR=$GOLD_DIR -param_file $PIG_PARAM_PATH/item_eligibility_item_loc_sears_srim_validation.param $PIG_SCRIPT_PATH/../../../shared/generic_validation_audit.pig
